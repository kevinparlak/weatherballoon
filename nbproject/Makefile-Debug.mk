...
# CC Compiler Flags
CCFLAGS=-lraspicam -lwiringPi -lwiringPiDev
CXXFLAGS=-lraspicam -lwiringPi -lwiringPiDev
...
${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../raspicam -I../../wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/pressure.o: pressure.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../raspicam -I../../wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/pressure.o pressure.cpp

${OBJECTDIR}/servo.o: servo.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../raspicam -I../../wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/servo.o servo.cpp

${OBJECTDIR}/temp.o: temp.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I../../raspicam -I../../wiringPi -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/temp.o temp.cpp
